...
1. **Existing commands** in `.claude/commands/`
2. **Existing rules** in `.claude/rules/`
3. **Existing skills** in `.claude/skills/`
4. **Existing agents** in `.claude/agents/`
5. **Project documentation** in `CLAUDE.md`, `.specify/memory/`
...
- `Read` - Read existing files for comparison
- `Glob` - Find existing assets
- `Grep` - Search for similar content/patterns
