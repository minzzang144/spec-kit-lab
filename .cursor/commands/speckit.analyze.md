...
If `.cursor/rules/gem-fsd-architecture.md` exists, load it and cross-check all spec documents against it:

1. **Load** `.cursor/rules/gem-fsd-architecture.md` in full
...
> `.cursor/rules/gem-fsd-architecture.md` but spec documents (research.md/plan.md/tasks.md)
