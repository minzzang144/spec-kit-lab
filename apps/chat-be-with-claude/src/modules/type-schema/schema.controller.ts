...
export class SchemaController {
  ...
  @ApiOperation({
    ...
    description: 'Frontend에서 TypeScript 타입을 자동 생성하기 위한 Socket.IO 이벤트 스키마를 반환합니다.'
  })
  @ApiResponse({
    status: 200,
    ...
    schema: {
      ...
      properties: {
        ...
        clientToServer: { type: 'object', description: 'Client → Server 이벤트 스키마' },
        serverToClient: { type: 'object', description: 'Server → Client 이벤트 스키마' },
        dataModels: { type: 'object', description: '데이터 모델 스키마' },
        typescript: { type: 'string', description: 'TypeScript 인터페이스 코드' }
      }
    }
  })
  ...
  @ApiOperation({
    ...
    description: '클라이언트에서 서버로 전송하는 Socket.IO 이벤트들의 스키마를 반환합니다.'
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description: '서버에서 클라이언트로 전송하는 Socket.IO 이벤트들의 스키마를 반환합니다.'
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description: '애플리케이션에서 사용하는 데이터 모델들의 스키마를 반환합니다.'
  })
  @ApiResponse({
    status: 200,
