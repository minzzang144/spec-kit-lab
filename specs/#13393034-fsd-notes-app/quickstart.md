...
├── Features/    # 6개 기능 (NoteWrite, NoteEdit, NoteDelete, NoteSearch, CategoryWrite, CategoryFilter)
...
2. **상위/하위 도메인**: Note(상위) ← NoteWrite/NoteEdit/NoteDelete(하위)
