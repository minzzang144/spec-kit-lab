...
- [ ] T008 Create `apps/notes-app/src/Shared/Type/Common.ts` with shared API response types (`ApiResponse<T>`, `ApiError`) and `apps/notes-app/src/Shared/Type/index.ts` barrel export
